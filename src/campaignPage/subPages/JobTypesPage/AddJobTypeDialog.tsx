...
const AddJobTypeDialog = (props: AddJobTypeDialogProps) => {
    ...
    const addType = async () => {
        ...
        const res = await ServerRequestMaker.MakePostRequest(
            ...
            config.ControllerUrls.JobType.AddJobType +
            campaignGuid,
            {
                JobTypeName: nameRef.current?.value,
                JobTypeDescription: descriptionRef.current?.value,
...
export default AddJobTypeDialog;
